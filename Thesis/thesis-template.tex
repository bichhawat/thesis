...
\newcommand{\colloquium}[7]{%
  ...
  \begin{flushleft}
	...
	\large Day of the Colloquium & \large #1\\[1mm]
	\large Dean of the Faculty & \large #2 \\[1mm]
	& \\[1mm]
	\large Chair of the Committee & \large #3 \\[1mm]
	\large Reviewers & \large #4 \\[1mm]
	\large  & \large #5 \\[1mm]
	\large & \large #6 \\[1mm]
	\large Academic Assistant & \large #7\\
    \end{tabular}%
  \end{flushleft}	
